...
const WindowToolbar: React.FC<WindowToolbarProps> = ({ id, tickers, selectedTicker, onTickerChange, onExpand, onAdd, onClose, onSplit }) => (
  <div className=" md:text-xs lg:text-base text-[8px] flex items-center space-x-2 w-full px-4 py-1 ml-1 rounded bg-gray-100 border-b border-gray-300">
    <span className="font-bold text-gray-800">Company info</span>
    <Dropdown
      tickers={tickers}
